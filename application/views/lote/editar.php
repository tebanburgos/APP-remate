	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form class="form" action="<?php echo site_url('lote/editar_lote').'/'.$rematador_codigo.'/'.$lote_codigo; ?>" method="POST"  enctype="multipart/form-data">
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-6">

								<input type="hidden" name="remate_id" value="<?php echo $remate_codigo; ?>">							
							...
							<div class="col-md-6">									
								...
								<div class="form-group">
									...
									<input type="file" id="lote_documento_adjunto" name="lote_documento_adjunto">
								...
								<div class="form-group">
									...
									<input type="hidden" name="lote_documento_adjunto_sin_editar" value="<?php echo $lote->lote_documento_adjunto; ?>">
								</div>
								...
								<div class="form-group">
									...
									<input type="file" id="lote_adjuntar_foto" name="lote_adjuntar_foto_1" >
								...
								<div class="form-group">
									...
									<?php $i++; ?>
									<input type="hidden" name="foto_id_<?php echo $i; ?>" value="<?php echo $lf['foto_id']; ?>">
									<input type="hidden" name="lote_adjuntar_foto_antigua_<?php echo $i; ?>" value="<?php echo $lf['foto_url']; ?>">
							...
							<div class="col-md-12">
								<button type="submit" class="btn btn-success btn-lg pull-right" id="editar-lote-l"><i class="fa fa-plus"></i> Editar lote</button>
							</div>
						</div>
					</div>
				</form>
