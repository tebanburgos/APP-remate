                                        ...
                                        <tr>
                                            <td width="695" style="font-family: Tahoma, Arial, sans-serif; text-align:left; font-size: 12px; color: #000000; padding: 20px;">
                                                ...
                                                <strong style="color:#666;">
													...
													<p>Gracias por su interés y por este remate</p>
													<br>
													<p>El archivo adjuntado fue enviado al rematador para habilitar su oferta dentro de este remate</p>
													<br>
													<br>
													<p>Sólo para dar constancia, los datos del remate son:</p>
													<p>Nombre del remate: <?php echo $remate_nombre; ?></p>
													<p>Nombre del mandante: <?php echo $remate_nombre_mandante; ?></p>
													<p>Precio de la garantía: <?php echo $remate_precio_garantia; ?></p>
