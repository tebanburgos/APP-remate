                                        ...
                                        <tr>
                                            <td width="695" style="font-family: Tahoma, Arial, sans-serif; text-align:left; font-size: 12px; color: #000000; padding: 20px;">
                                                ...
                                                <strong style="color:#666;">
													...
													<p>Le informamos que su registro ha sido confirmado</p>
													<br>
													<br>
													<p>Email (Login): <?php echo $ofertante_correo; ?></p>
													<p>Alias : <?php echo $ofertante_nickname; ?></p>
													<p>Password 	: *** ENVIADA ANTERIORMENTE EN EL CORREO "Registro de Ofertantes" ***</p>
													<br>
													<br>
													<p>Ud ya puede participar en las subastas que le interesen dentro del sistema</p>
                                                    <br><br>
                                                    <p>Atentamente,</p>
                                                    <p>El Equipo Re-Remate.</p> 
													
													<small>Por razones de seguridad no almacenamos tu contraseña. En su lugar, dentro de la plataforma hay instrucciones para que puedas establecer una nueva en caso de haberla perdido u olvidado.</small>
                                                </strong>
